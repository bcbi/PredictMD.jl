...
#
Base.Test.@test( !PredictMD.something_exists_at_path( ENV["logisticclassifier_filename"] ) )
Base.Test.@test( !PredictMD.something_exists_at_path( ENV["rfclassifier_filename"] ) )
Base.Test.@test( !PredictMD.something_exists_at_path( ENV["csvc_svmclassifier_filename"] ) )
Base.Test.@test( !PredictMD.something_exists_at_path( ENV["nusvc_svmclassifier_filename"] ) )
Base.Test.@test( !PredictMD.something_exists_at_path( ENV["knetmlp_filename"] ) )
