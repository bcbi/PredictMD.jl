...
function save_model_jld2(
    ...
    Compat.@info("Attempting to save model...")
    ...
    Compat.@info(string("Saved model to file \"", filename, "\""))
    return filename
end
